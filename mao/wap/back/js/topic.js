...
jQuery.extend({
	...
	//alert($.trim(data.data_3));!$.trim($("userName")..val()
	if(!$.trim(data.data_3)){
    ...
    $.getJSON(url,{name:data.data_1,phone:data.data_2,brand:data.data_3,chexi:data.data_4,style:data.data_5},function(response){
